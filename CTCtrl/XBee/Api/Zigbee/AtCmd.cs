...
namespace NETMF.OpenSource.XBee.Api.Zigbee
{
    ...
    public enum AtCmd : ushort
    {
        ...
        /// <para>Range: 0 - 0xFFFE・[read-only].</para>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Range: 0 - 0xFFFFFFFF ゼread-only].</para>
        ...
        /// <para>Range: 20-Byte printable アSCII string.</para>
        ...
        /// used to determine an acceptable channel and Pan ID for the Coordinator to startup on.・/para>
        ...
        /// <para>Range: 0 - 0xFF ゼx 1 sec].</para>
        /// <para>Default: 0xFF ・always allows joining).</para>
        /// <para>Applicable: Coordinator, Router, End Device.</para>
        /// </remarks>
        [AtString("NJ")]
        NodeJoinTime = 0x4E4A,
        ...
        /// For XBee (S2), onlythe default power level (PL=4) is guaranteed from -40 to 85ｰ C.
        /// <para>Range: 0-4.</para>
        /// <para>Default: 4.</para>
        /// <para>Applicable: Coordinator, Router, End Device.</para>
        /// </remarks>
        ...
        /// <para>Range: optional 20-Byte クI or MY value.</para>
        /// <para>Applicable: Coordinator, Router, End Device.</para>
        /// </remarks>
        [AtString("ND")]
        NodeDiscover = 0x4E44,
        ...
        /// not specified (left blank), the command is terminated and an 摘RROR・message is returned. 
